...
const featureIcons: Record<FeatureCardProps["icon"], ReactElement> = {
  shield: (
    <svg viewBox="0 0 24 24" className="h-6 w-6 text-[#009AD9]" fill="none" stroke="currentColor" strokeWidth="1.5">
...
export default function FeatureCard({ title, description, icon }: FeatureCardProps) {
  return (
    <div className="rounded-[2rem] border border-[#A88243]/20 bg-[#F4F7FA] p-6 text-slate-950 shadow-sm transition hover:-translate-y-1 hover:shadow-[0_24px_80px_-50px_rgba(15,23,42,0.08)] dark:border-slate-700/40 dark:bg-slate-950 dark:text-slate-100">
      <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-3xl bg-[#009AD9]/10">
        {featureIcons[icon]}
      </div>
