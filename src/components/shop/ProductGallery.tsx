...
import { darkBlueHex, goldHex, creamHex } from '@/constants/variables';
...
export default function ProductGallery({ images, name }: { images: string[]; name: string }) {
  ...
  return (
    <div className="flex gap-3">
        ...
        <div className="flex flex-col gap-3">
          {gallery.map((image, index) => (
            <button
              ...
              style={{
                borderColor: index === activeIndex ? darkBlueHex : 'transparent',
      ...
      <div className="relative aspect-square flex-1 overflow-hidden rounded-3xl shadow-md" style={{ backgroundColor: creamHex }}>
        <Image
          src={activeImage}
          alt={name}
          fill
